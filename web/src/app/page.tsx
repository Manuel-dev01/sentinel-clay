...
import { EXPLORER_OBJ, PACKAGE_ID } from '@/lib/env';

const ML = 'font-mono text-xs font-semibold tracking-[0.16em] text-gold';
const GITHUB = 'https://github.com/Manuel-dev01/sentinel-clay';

const FOOTER: { h: string; items: { label: string; href: string; ext?: boolean }[] }[] = [
  {
    h: 'PRODUCT',
    items: [
      { label: 'Mandate wallet', href: '/wallet' },
  ...
  },
  {
    h: 'DEVELOPERS',
    items: [
      { label: 'Docs', href: GITHUB, ext: true },
      { label: 'Move policy', href: '/policy' },
  ...
  },
  {
    h: 'COMPANY',
    items: [
      { label: 'Explorer', href: EXPLORER_OBJ(PACKAGE_ID), ext: true },
      { label: 'Security', href: `${GITHUB}#security`, ext: true },
      { label: 'Contact', href: GITHUB, ext: true },
    ],
  },
];
...
function Nav() {
  return (
    <div className="sticky top-0 z-50 border-b border-hair bg-forest">
      <div className="mx-auto flex max-w-[1180px] items-center justify-between px-5 md:px-10 py-[18px]">
...
function Stat({ value, label }: { value: React.ReactNode; label: string }) {
  return (
    <div className="border-hair px-5 py-[26px] [&:nth-child(-n+2)]:border-b [&:nth-child(odd)]:border-r md:flex-1 md:border-b-0 md:border-r md:px-10 md:py-[30px] md:last:border-r-0">
      <div className="font-sans text-[30px] md:text-[40px] font-black leading-none tracking-tight text-cream">{value}</div>
...
function PathStep({ n, title, body, accent }: { n: string; title: string; body: string; accent: string }) {
  return (
    <div className="border-b border-hair px-[30px] py-[30px] last:border-b-0 md:flex-1 md:border-b-0 md:border-r md:last:border-r-0">
...
export default function Landing() {
  return (
    <div className="w-full overflow-x-hidden">
      ...
      <div className="mx-auto max-w-[1180px] px-5 md:px-10 pb-[76px] pt-[72px]">
        <div className={`${ML} mb-7`}>DAILY BUDGET · ENFORCED ON-CHAIN</div>
        <div className="mb-[18px] flex flex-wrap items-end justify-between gap-x-4">
          <div className="font-sans text-[72px] sm:text-[100px] md:text-[132px] font-black leading-[0.8] tracking-[-0.05em] text-cream">
            <CountUp to={48} />
            <span className="text-[34px] sm:text-[46px] md:text-[60px] text-[#7fa08f]">.20</span>
            <span className="text-[24px] sm:text-[32px] md:text-[40px] text-[#7fa08f]"> SUI</span>
          </div>
          <div className="pb-4 font-mono text-[18px] md:text-[26px] font-bold text-muted">of 50 SUI</div>
        </div>
        ...
        <div className="mb-12 flex justify-between font-mono text-xs text-muted">
          <span>0 SUI</span>
          <span className="text-abort">a 500 SUI trade → blocked here</span>
        </div>
        <div className="flex flex-wrap items-end justify-between gap-10">
          <div>
            <h1 className="m-0 font-sans text-[34px] md:text-[52px] font-extrabold leading-[1.02] tracking-tight text-cream">
              A treasury that
              <br />
              cannot be overspent.
            </h1>
            ...
            <div className="mt-8 flex flex-wrap items-center gap-3.5">
              <Link href="/wallet" className="bg-gold px-7 py-[17px] font-sans text-[15px] font-bold text-ink transition-opacity hover:opacity-90">
                Arm your mandate
              </Link>
              <a href="#sim" className="border border-hair px-[26px] py-4 font-sans text-[15px] font-semibold text-cream transition-colors hover:border-cream">
                Try the policy
              </a>
            </div>
          </div>
      ...
      <div className="border-y border-hair">
        <div className="mx-auto grid max-w-[1180px] grid-cols-2 md:flex">
      ...
      {/* EXECUTION PATH */}
      <div id="path" className="mx-auto max-w-[1180px] px-5 md:px-10 py-[64px] md:py-[100px] scroll-mt-20">
        <div className="mb-[54px] flex flex-col gap-5 md:flex-row md:items-end md:justify-between">
          <div>
            <div className={`${ML} mb-[18px]`}>01 · EXECUTION PATH</div>
            <h2 className="m-0 max-w-[560px] font-sans text-[30px] md:text-[46px] font-extrabold leading-[1.05] tracking-tight text-cream">
        ...
        <div className="flex flex-col border-t border-hair md:flex-row">
      ...
      <div id="sim" className="scroll-mt-20 border-y border-hair bg-panel">
        <div className="mx-auto max-w-[1180px] px-5 md:px-10 py-[64px] md:py-[100px]">
          <div className="mb-11">
            <div className={`${ML} mb-[18px]`}>02 · TRY THE POLICY · LIVE</div>
            <h2 className="m-0 font-sans text-[30px] md:text-[46px] font-extrabold leading-[1.05] tracking-tight text-cream">
      ...
      <div className="mx-auto max-w-[1180px] px-5 md:px-10 py-[64px] md:py-[100px]">
        ...
        <h2 className="mb-[50px] mt-0 max-w-[620px] font-sans text-[30px] md:text-[46px] font-extrabold leading-[1.05] tracking-tight text-cream">
        ...
        <div className="flex flex-wrap items-stretch gap-4">
          <div className="flex min-w-[260px] flex-1 flex-col gap-4">
            <div className="border border-hair p-[26px]">
              ...
              <div className="font-sans text-[38px] font-black tracking-tight text-gold">50 SUI</div>
            </div>
            <div className="border border-hair p-[26px]">
          ...
          <div className="flex min-w-[260px] flex-1 flex-col bg-gold p-[26px]">
            ...
            <p className="m-0 font-sans text-lg font-semibold leading-relaxed text-ink">
              Spend up to 50 SUI/day, trading only stablecoins and blue-chips on SUI/DEEP and SUI/DBUSDC. Expires in 7
              days.
            </p>
      ...
      <div className="bg-gold">
        <div className="mx-auto flex max-w-[1180px] flex-wrap items-center justify-between gap-8 px-5 md:px-10 py-[90px]">
          <div>
            <h2 className="m-0 font-sans text-[34px] md:text-[56px] font-black leading-[0.96] tracking-tight text-ink">Arm your mandate.</h2>
          ...
          <div className="flex items-center gap-3.5">
            <Link href="/wallet" className="bg-ink px-[30px] py-[18px] font-sans text-[15px] font-bold text-gold transition-opacity hover:opacity-90">
              Launch Sentinel
            </Link>
            <Link href="/policy" className="border border-ink px-[26px] py-[17px] font-sans text-[15px] font-semibold text-ink transition-colors hover:bg-ink/10">Read the Move policy</Link>
          </div>
        </div>
      </div>
      ...
      <div className="bg-panel">
        <div className="mx-auto flex max-w-[1180px] flex-wrap justify-between gap-10 px-5 md:px-10 pb-10 pt-16">
          ...
          <div className="flex flex-wrap gap-x-[60px] gap-y-8">
            {FOOTER.map((col) => (
              <div key={col.h}>
                <div className="mb-4 font-mono text-[11px] font-semibold tracking-[0.14em] text-dim">{col.h}</div>
                <div className="flex flex-col gap-2.5 font-sans text-sm font-medium text-[#cfd8ce]">
                  {col.items.map((i) =>
                    i.ext ? (
                      <a key={i.label} href={i.href} target="_blank" rel="noreferrer" className="w-fit transition-colors hover:text-cream">
                        {i.label}
                      </a>
                    ) : (
                      <Link key={i.label} href={i.href} className="w-fit transition-colors hover:text-cream">
                        {i.label}
                      </Link>
                    ),
                  )}
        ...
        <div className="mx-auto flex max-w-[1180px] justify-between border-t border-white/10 px-5 md:px-10 py-5 font-mono text-[11px] font-medium tracking-[0.06em] text-dim">
