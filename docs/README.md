...
Product and developer docs for **Sentinel** - an agent-native, key-safe DeFi treasury on Sui, where an
AI agent can only *propose* trades and a Move policy enforces your budget on every one.
...
New here? Start with [Getting started](getting-started.md), then [How it works](architecture.md).
